    ...
    <section className="w-full py-10 bg-primary-200 " id="classes">
      <div className="container">
        ...
        <p className="w-full md:w-[60%] mt-3 text-primary-300">
          ...
          crafts,Mikegym group fitness classes are designed for maximum results
          and maximum fun. Looking for new ways to stay fit? We’ve got you
          covered with all your favorites, including Cycling, Zumba, HIIT, Yoga,
          Les Mills and more. Whether you’re just starting out on your fitness
          journey, or are a conditioned fitness enthusiast, our group fitness
          classes make it easy to stay consistent and reach your goals, all
          while being a part of an inclusive and supportive community.
        </p>
